...
public class MySimpleLinkedBlockingQueue<T> implements BlockingQueue<T>, Serializable {
	...
	/**
	 * моя простая реализация блокирующей очереди на двусвязном списке
	 */
	...
	private synchronized T retrieveItems() { // общий метод для
												// poll(),
												// remove(), take())
	...
	private synchronized void addToQueue(Object object) { // общий метод для
															// put(),
															// add(), offer()
